...
const CardEducation: FC<Props> = ({ education }) => {
  ...
  return (
    <li className="max-w-[346px]">
      ...
      <div className="border-l border-l-gray-400 pl-8 py-4 mt-4 ml-6 max-w-[335px] flex items-center">
        <div className="bg-white w-72 rounded-2xl px-12 py-10 shadow-xl">
